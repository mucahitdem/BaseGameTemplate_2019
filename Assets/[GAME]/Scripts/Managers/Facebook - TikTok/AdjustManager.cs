...
namespace com.adjust.sdk
{
    ...
    {
        public static AdjustManager Instance { get; private set; } = null;
        ...
        void Awake()
        {
            ...
            if (!this.startManually)
            {
                ...
                AdjustManager.start(adjustConfig);
            }
        }
...
#if UNITY_IOS
            AdjustManager.eventSuccessDelegate = adjustConfig.getEventSuccessDelegate();
            AdjustManager.eventFailureDelegate = adjustConfig.getEventFailureDelegate();
            AdjustManager.sessionSuccessDelegate = adjustConfig.getSessionSuccessDelegate();
            AdjustManager.sessionFailureDelegate = adjustConfig.getSessionFailureDelegate();
            AdjustManager.deferredDeeplinkDelegate = adjustConfig.getDeferredDeeplinkDelegate();
            AdjustManager.attributionChangedDelegate = adjustConfig.getAttributionChangedDelegate();
            AdjustManager.conversionValueUpdatedDelegate = adjustConfig.getConversionValueUpdatedDelegate();
...
#if UNITY_IOS
            if (AdjustManager.authorizationStatusDelegates == null)
            {
                AdjustManager.authorizationStatusDelegates = new List<Action<int>>();
            }
            AdjustManager.authorizationStatusDelegates.Add(statusCallback);
        ...
        public void GetNativeAttribution(string attributionData)
        {
            ...
            if (AdjustManager.attributionChangedDelegate == null)
            {
            ...
            AdjustManager.attributionChangedDelegate(attribution);
        }
        ...
        public void GetNativeEventSuccess(string eventSuccessData)
        {
            ...
            if (AdjustManager.eventSuccessDelegate == null)
            {
            ...
            AdjustManager.eventSuccessDelegate(eventSuccess);
        }
        ...
        public void GetNativeEventFailure(string eventFailureData)
        {
            ...
            if (AdjustManager.eventFailureDelegate == null)
            {
            ...
            AdjustManager.eventFailureDelegate(eventFailure);
        }
        ...
        public void GetNativeSessionSuccess(string sessionSuccessData)
        {
            ...
            if (AdjustManager.sessionSuccessDelegate == null)
            {
            ...
            AdjustManager.sessionSuccessDelegate(sessionSuccess);
        }
        ...
        public void GetNativeSessionFailure(string sessionFailureData)
        {
            ...
            if (AdjustManager.sessionFailureDelegate == null)
            {
            ...
            AdjustManager.sessionFailureDelegate(sessionFailure);
        }
        ...
        public void GetNativeDeferredDeeplink(string deeplinkURL)
        {
            ...
            if (AdjustManager.deferredDeeplinkDelegate == null)
            {
                Debug.Log("[Adjust]: Deferred deeplink delegate was not set.");
                return;
            }

            AdjustManager.deferredDeeplinkDelegate(deeplinkURL);
        }
        ...
        public void GetNativeConversionValueUpdated(string conversionValue)
        {
            ...
            if (AdjustManager.conversionValueUpdatedDelegate == null)
            {
            ...
            if (Int32.TryParse(conversionValue, out cv))
            {
                if (cv != -1)
                {
                    AdjustManager.conversionValueUpdatedDelegate(cv);
                }
            }
        }
        ...
        public void GetAuthorizationStatus(string authorizationStatus)
        {
            ...
            foreach (Action<int> callback in AdjustManager.authorizationStatusDelegates)
            {
                callback(Int16.Parse(authorizationStatus));
            }
            AdjustManager.authorizationStatusDelegates.Clear();
        }
#endif
