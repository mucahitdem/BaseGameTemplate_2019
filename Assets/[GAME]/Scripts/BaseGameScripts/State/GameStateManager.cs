...
namespace Scripts.State
{
    public class GameStateManager : MonoBehaviour 
    {
        ...
        private bool _firstState = false;
        ...
        {
            List<Type> subClasses = AssemblyManager.GetSubClassesOfType(typeof(BaseGameState));
        ...
        /// "isSucceeded" represent win/lose situation of current state. If sub level is "0", it is fail. Else if it is "1", it is success
        /// </summary>
